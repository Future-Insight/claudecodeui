            ...
            <div className="w-full mb-2">
              <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/50 rounded-lg p-2 shadow-sm">
                <div className="flex items-start">
                  ...
                  <div className="flex-1 min-w-0 pl-3 border-l border-blue-300 dark:border-blue-700/50 py-0.5">
                  ...
                  <div className={`mt-2 border-t  pt-2 ${message.isError
                    ...
                    <div className={`text-sm ${message.isError
                      ...
                      {(() => {
                        ...
                        // Special handling for tool_use_error messages
                        if (content.includes('<tool_use_error>') && content.includes('</tool_use_error>')) {
                          // Extract error content between tags
