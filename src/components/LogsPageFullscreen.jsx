...
import { Terminal, X, RotateCcw, ArrowLeft } from 'lucide-react';
import { useParams, useNavigate } from 'react-router-dom';
import { authenticatedFetch } from '../utils/api';

function LogsPageFullscreen() {
  ...
  const fetchLogs = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await authenticatedFetch(`/api/project/${encodeURIComponent(projectName)}/preview/logs`);
...
export default LogsPageFullscreen;