          ...
          if (entry.sessionId) {
            ...
            if (entry.type === 'summary' && entry.summary) {
              ...
              if (typeof content === 'string' && content.length > 0) {
                // Skip command messages that start with <command-name>/<local-command-stdout>
                // 跳过 content以"Caveat: The messages below were generated"开始
                if (!content.startsWith('<command-name>') && !content.startsWith('<local-command-stdout>') && !content.startsWith('Caveat: The messages below were generated')) {
                  session.summary = content.length > 25 ? content.substring(0, 25) + '...' : content;
                }
              }
            }
